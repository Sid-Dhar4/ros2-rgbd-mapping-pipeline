...
The screenshot shows the accumulated `/map/cloud` output in RViz with `world` as the fixed frame. The map is generated by the C++/PCL accumulator from filtered RGB-D point clouds and TUM ground-truth TF poses.
